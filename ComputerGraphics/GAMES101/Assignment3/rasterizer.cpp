...
{
    auto v = t.toVector4();
    int x_min = std::floor(std::min({float(t.v[0][0]),float(t.v[1][0]),float(t.v[2][0])}));
    int x_max = std::ceil(std::max({float(t.v[0][0]),float(t.v[1][0]),float(t.v[2][0])}));
    int y_min = std::floor(std::min({float(t.v[0][1]),float(t.v[1][1]),float(t.v[2][1])}));
    int y_max = std::ceil(std::max({float(t.v[0][1]),float(t.v[1][1]),float(t.v[2][1])}));
