    ...
    def train(self, steps=500, episode_length=10000):
        ...
        for episode in range(steps):
            ...
            while iters < episode_length:
                ...
                self.Q[s0[0], s0[1], a0_idx] += lr * (
                            r + self.gamma * self.Q[s1[0], s1[1], a1_idx] - self.Q[s0[0], s0[1], a0_idx])
                returns += r
                if done:
                    break
                s0_v = s1_v
